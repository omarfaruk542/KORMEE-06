CREATE VIEW [dbo].[EmployeePermanentAddress]
AS

SELECT A.ESID,A.PermanentGeoCodeID,C.Division,DivisionLocal,D.District,DistrictLocal,E.Upazila,UpazilaLocal,
F.UN_WRD,UN_WRDLocal,G.MZA_MOH,MZA_MOHLocal,H.Village,VillageLocal,A.PermanentPostCode,A.PermanentAddress 
FROM Employee.ActiveEmployeeAddress A
JOIN SysInfo.GeoCode B ON A.PermanentGeoCodeID = B.SystemID
LEFT JOIN (
